...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/moviesofficial566')
            ],
            [
                InlineKeyboardButton('⚡ Updates ⚡', url=f"https://t.me/moviesofficial566"),
            ],
            [
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        if message.command[1] != "🔆彡 MOVIES OFFICIAL🔆彡":
            try:
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('Support Group', url='https://t.me/moviesofficial566/329')],
        [InlineKeyboardButton('Updates Channel', url='https://t.me/moviesofficial566'),
        InlineKeyboardButton('🔆彡 MOVIES OFFICIAL🔆彡', url='https://t.me/moviesofficial566')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
